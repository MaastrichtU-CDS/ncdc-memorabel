 ...
 # RIRS model with unstructured covariance structure (add model for every biomarker x cognitive measure)
  ...
  results <- list(
      ...
      "summary_language_amyloid_b_ratio_apoe_pos" = summary_language_amyloid_b_ratio_apoe_pos,
       ...
       "summary_executive_cst_p_tau_apoe_neg" = summary_executive_cst_p_tau_apoe_neg,
       "summary_executive_cst_p_tau_apoe_pos" = summary_executive_cst_p_tau_apoe_pos,
       "summary_executive_cst_gfap_apoe_neg" = summary_executive_cst_gfap_apoe_neg,
       "summary_executive_cst_gfap_apoe_pos" = summary_executive_cst_gfap_apoe_pos,
       "summary_executive_cst_nfl_apoe_neg" = summary_executive_cst_nfl_apoe_neg,
       "summary_executive_cst_nfl_apoe_pos" = summary_executive_cst_nfl_apoe_pos,
       "summary_executive_cst_amyloid_b_ratio_apoe_neg" = summary_executive_cst_amyloid_b_ratio_apoe_neg,
       "summary_executive_cst_amyloid_b_ratio_apoe_pos" = summary_executive_cst_amyloid_b_ratio_apoe_pos,

       "summary_executive_cst_shifting_p_tau_apoe_neg" = summary_executive_cst_p_tau_apoe_neg,
       "summary_executive_cst_shifting_p_tau_apoe_pos" = summary_executive_cst_p_tau_apoe_pos,
       "summary_executive_cst_shifting_gfap_apoe_neg" = summary_executive_cst_gfap_apoe_neg,
       "summary_executive_cst_shifting_gfap_apoe_pos" = summary_executive_cst_gfap_apoe_pos,
       "summary_executive_cst_shifting_nfl_apoe_neg" = summary_executive_cst_nfl_apoe_neg,
       "summary_executive_cst_shifting_nfl_apoe_pos" = summary_executive_cst_nfl_apoe_pos,
       "summary_executive_cst_shifting_amyloid_b_ratio_apoe_neg" = summary_executive_cst_amyloid_b_ratio_apoe_neg,
       "summary_executive_cst_shifting_amyloid_b_ratio_apoe_pos" = summary_executive_cst_amyloid_b_ratio_apoe_pos,
