...
##Z-score: executive functioning - interference
  ...
  df$priority_executive_stroop_interf_z <- -df$priority_executive_stroop_interf_z
    ...
    summary_attention_tmt_a_p_tau <- safe_lme_summary(priority_attention_tmt_a_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + p_tau
                                            + p_tau * years_since_baseline
                                            + sex * p_tau
                                            + sex * years_since_baseline
                                            + sex * p_tau * years_since_baseline,
    ...
    summary_attention_tmt_a_gfap <- safe_lme_summary(priority_attention_tmt_a_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + gfap
                                     + gfap * years_since_baseline
                                     + sex * gfap
                                     + sex * years_since_baseline
                                     + sex * gfap * years_since_baseline,
    ...
    # summary_attention_tmt_a_nfl <- safe_lme_summary(priority_attention_tmt_a_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + nfl
    #                                 + nfl * years_since_baseline
    #                                 + sex * nfl
    #                                 + sex * years_since_baseline
    #                                 + sex * nfl * years_since_baseline,
    ...
    summary_attention_tmt_a_amyloid_b_ratio <- safe_lme_summary(priority_attention_tmt_a_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + amyloid_b_ratio_42_40
                                                + amyloid_b_ratio_42_40 * years_since_baseline
                                                + sex * amyloid_b_ratio_42_40
                                                + sex * years_since_baseline
                                                + sex * amyloid_b_ratio_42_40 * years_since_baseline,
    ...
    summary_priority_executive_tmt_b_p_tau <- safe_lme_summary(priority_executive_tmt_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + p_tau
                                        + p_tau * years_since_baseline
                                        + sex * p_tau
                                        + sex * years_since_baseline
                                        + sex * p_tau * years_since_baseline,
    ...
    summary_priority_executive_tmt_b_gfap <- safe_lme_summary(priority_executive_tmt_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + gfap
                                     + gfap * years_since_baseline
                                     + sex * gfap
                                     + sex * years_since_baseline
                                     + sex * gfap * years_since_baseline,
    ...
    # summary_priority_executive_tmt_b_nfl <- safe_lme_summary(priority_executive_tmt_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + nfl
    #                                 + nfl * years_since_baseline
    #                                 + sex * nfl
    #                                 + sex * years_since_baseline
    #                                 + sex * nfl * years_since_baseline,
    ...
    summary_priority_executive_tmt_b_amyloid_b_ratio <- safe_lme_summary(priority_executive_tmt_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + amyloid_b_ratio_42_40
                                                + amyloid_b_ratio_42_40 * years_since_baseline
                                                + sex * amyloid_b_ratio_42_40
                                                + sex * years_since_baseline
                                                + sex * amyloid_b_ratio_42_40 * years_since_baseline,
    ...
    summary_priority_executive_shift_tmt_z_p_tau <- safe_lme_summary(priority_executive_shift_tmt_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + p_tau
                                      + p_tau * years_since_baseline
                                      + sex * p_tau
                                      + sex * years_since_baseline
                                      + sex * p_tau * years_since_baseline,
    ...
    summary_priority_executive_shift_tmt_z_gfap <- safe_lme_summary(priority_executive_shift_tmt_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + gfap
                                     + gfap * years_since_baseline
                                     + sex * gfap
                                     + sex * years_since_baseline
                                     + sex * gfap * years_since_baseline,
    ...
    # summary_priority_executive_shift_tmt_z_nfl <- safe_lme_summary(priority_executive_shift_tmt_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + nfl
    #                                 + nfl * years_since_baseline
    #                                 + sex * nfl
    #                                 + sex * years_since_baseline
    #                                 + sex * nfl * years_since_baseline,
    ...
    summary_priority_executive_shift_tmt_z_amyloid_b_ratio <- safe_lme_summary(priority_executive_shift_tmt_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + amyloid_b_ratio_42_40
                                                + amyloid_b_ratio_42_40 * years_since_baseline
                                                + sex * amyloid_b_ratio_42_40
                                                + sex * years_since_baseline
                                                + sex * amyloid_b_ratio_42_40 * years_since_baseline,
