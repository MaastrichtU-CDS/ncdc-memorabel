RPC_models_lls_norm <- function(df, config, model = "memory", exclude=c()) {
  ...
  result = tryCatch({
    ...
    summary_model_im_lm_rse <- rse
    summary_model_im_lm_residual <- df.residual(model_im_lm)
    ...
    summary_model_dr_lm_rse <- rse2
    summary_model_dr_lm_residual <- df.residual(model_dr_lm)
    ...
    results <- list(
      ...
      "summary_model_im_lm_rse"=summary_model_im_lm_rse,
      "summary_model_dr_lm_rse"=summary_model_dr_lm_rse,
      "summary_model_im_lm_residual"=summary_model_im_lm_residual,
      "summary_model_dr_lm_residual"=summary_model_dr_lm_residual,
