...
##Stroop: van der Elst norms
  ...
  #CS model with unstructured covariance structure (add model for every biomarker x cognitive measure)
   ...
   #Attention (Stroop)
    ...
    summary_CS_attention_stroop_average_p_tau <- safe_lme_summary(priority_attention_stroop_average_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + p_tau
    ...
    # summary_CS_attention_stroop_average_p_tau <- sjPlot::tab_model(summary_CS_attention_stroop_average_p_tau, digits = 10)

    vtg::log$info("summary_CS_attention_stroop_average_gfap")
    summary_CS_attention_stroop_average_gfap <- safe_lme_summary(priority_attention_stroop_average_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + gfap
    ...
    # summary_CS_attention_stroop_average_gfap <- sjPlot::tab_model(summary_CS_attention_stroop_average_gfap, digits = 10)

    vtg::log$info("summary_CS_attention_stroop_average_nfl")
    summary_CS_attention_stroop_average_nfl <- safe_lme_summary(priority_attention_stroop_average_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + nfl
    ...
    # summary_CS_attention_stroop_average_nfl <- sjPlot::tab_model(summary_CS_attention_stroop_average_nfl, digits = 10)

    vtg::log$info("summary_CS_attention_stroop_average_amyloid_b_ratio")
    summary_CS_attention_stroop_average_amyloid_b_ratio <- safe_lme_summary(priority_attention_stroop_average_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + amyloid_b_ratio_42_40
    ...
    # summary_CS_attention_stroop_average_amyloid_b_ratio <- sjPlot::tab_model(summary_CS_attention_stroop_average_amyloid_b_ratio, digits = 10)

  #Executive function (Stroop)
    vtg::log$info("summary_CS_priority_executive_stroop_3_p_tau")
    summary_CS_executive_stroop_3_p_tau <- safe_lme_summary(priority_executive_stroop_3_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + p_tau
                                        + p_tau * years_since_baseline
                                        + apoe_carrier * p_tau,
                            data = df,
                            method = "REML",
    ...
    vtg::log$info("summary_CS_priority_executive_stroop_3_gfap")
    summary_CS_executive_stroop_3_gfap <- safe_lme_summary(priority_executive_stroop_3_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + gfap
                                     + gfap * years_since_baseline
                                     + apoe_carrier * gfap,
                            data = df,
                            method = "REML",
    ...
    vtg::log$info("summary_CS_priority_executive_stroop_3_nfl")
    summary_CS_executive_stroop_3_nfl <- safe_lme_summary(priority_executive_stroop_3_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + nfl
                                    + nfl * years_since_baseline
                                    + apoe_carrier * nfl,
                            data = df,
                            method = "REML",
    ...
    vtg::log$info("summary_CS_priority_executive_stroop_3_amyloid_b_ratio")
    summary_CS_executive_stroop_3_amyloid_b_ratio <- safe_lme_summary(priority_executive_stroop_3_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + amyloid_b_ratio_42_40
                                                + amyloid_b_ratio_42_40 * years_since_baseline
                                                + apoe_carrier * amyloid_b_ratio_42_40,
                            data = df,
                            method = "REML",
    ...
    #Interference score
    vtg::log$info("summary_CS_priority_executive_stroop_interf_p_tau")
    summary_CS_executive_stroop_interf_p_tau <- safe_lme_summary(priority_executive_stroop_interf_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + p_tau
                                      + p_tau * years_since_baseline
                                      + apoe_carrier * p_tau,
                            data = df,
                            method = "REML",
    ...
    vtg::log$info("summary_CS_priority_executive_stroop_interf_gfap")
    summary_CS_executive_stroop_interf_gfap <- safe_lme_summary(priority_executive_stroop_interf_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + gfap
                                     + gfap * years_since_baseline
                                     + apoe_carrier * gfap,
                            data = df,
                            method = "REML",
    ...
    vtg::log$info("summary_CS_priority_executive_stroop_interf_nfl")
    summary_CS_executive_stroop_interf_nfl <- safe_lme_summary(priority_executive_stroop_interf_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + nfl
                                    + nfl * years_since_baseline
                                    + apoe_carrier * nfl,
                            data = df,
                            method = "REML",
    ...
    vtg::log$info("summary_CS_priority_executive_stroop_interf_amyloid_b_ratio")
    summary_CS_executive_stroop_interf_amyloid_b_ratio <- safe_lme_summary(priority_executive_stroop_interf_z ~ years_since_baseline + age_rec + sex + sqrt_prior_visit + education_low + education_high + apoe_carrier + amyloid_b_ratio_42_40
                                                + amyloid_b_ratio_42_40 * years_since_baseline
                                                + apoe_carrier * amyloid_b_ratio_42_40,
                            data = df,
                            method = "REML",
